<?php namespace App\Http\Controllers;
	...
	class AdminEntradasSalidasController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "persona_que_entrega";
			$this->limit = "20";
			...
			$this->col[] = ["label"=>"Fecha de Validez","name"=>"Fecha_validez"];
			$this->col[] = ["label"=>"Reservado Gerencia","name"=>"reservado_gerencia"];
			$this->col[] = ["label"=>"Fecha","name"=>"fecha"];
			$this->col[] = ["label"=>"Ubicación de Equipo","name"=>"Ubicacion_equipo"];
			$this->col[] = ["label"=>"Tipo de Movimiento","name"=>"tipo_movimiento"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Código','name'=>'Codigo','type'=>'text','validation'=>'required|min:1|max:50','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Edición','name'=>'Edicion','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Fecha Validez','name'=>'Fecha_validez','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Espacio Reservado Para Gerencia','name'=>'reservado_gerencia','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
