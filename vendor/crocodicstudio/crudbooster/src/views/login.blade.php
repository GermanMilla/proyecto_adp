...
<!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    ...
    <style type="text/css">
        ...
        .login-box-body {
            ...
            color: {{ CRUDBooster::getSetting("login_font_color")?:'#333333' }}  !important;
        }
...
<div class="login-logo">
        <a href="{{url('/')}}">
            <img title='{!!(Session::get('appname') == 'CRUDBooster')?"<b>CRUD</b>Booster":CRUDBooster::getSetting('appname')!!}'
                 src='{{ CRUDBooster::getSetting("logo")?asset(CRUDBooster::getSetting('logo')):asset('vendor/crudbooster/assets/logo_crudbooster.png') }}' width="50px"/>
        </a>
    </div> 
    <div class="login-box-body">
        ...
        @endif
        <p class='login-box-msg' style="font-size:18px;">Registro de Entradas y Salidas</p>
        ...
        <form autocomplete='off' action="{{ route('postLogin') }}" method="post">
            ...
            <div class="form-group has-feedback">
                <input autocomplete='off' type="text" class="form-control" name='email' required placeholder="Correo de usuario"/>
