    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-{{ cbLang('left') }} info">
                ...
                <!-- Badge de acuerdo al usuario -->

                @if(CRUDBooster::isSuperadmin())
                    <span class="badge badge-success" style="background-color:#00a65a;color:#333">{{ CRUDBooster::myPrivilegeName() }}</span>
                @else
                    <span class="badge badge-success" style="background-color:#605ca8">{{ CRUDBooster::myPrivilegeName() }}</span>
                @endif
