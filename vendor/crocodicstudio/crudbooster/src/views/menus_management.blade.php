        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    <strong>Menús activos</strong> <span id='menu-saved-info' style="display:none" class='pull-right text-success'><i
                                class='fa fa-check'></i> ¡Cambios Guardados!</span>
                </div>
                <div class="panel-body clearfix">
                    ...
                    @if(count($menu_active)==0)
                        <div align="center">Ningún menú encontrado</div>
                    @endif
                </div>
            </div>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class='form-horizontal' method='post' id="form" enctype="multipart/form-data" action='{{CRUDBooster::mainpath("add-save")}}'>
                        ...
                        <p align="right"><input type='submit' class='btn btn-primary' value='Agregar Menú al Panel'/></p>
                    </form>
                </div>
            </div>
        </div>
